...
def warn_in_virtualenv(project: Project):
...
def cleanup_virtualenv(project: Project, bare: bool = True):
...
def do_where(project: Project, virtualenv: bool = False, bare: bool = True):
...
def inline_activate_virtual_environment(project: Project):
...
def _inline_activate_venv(project: Project):
