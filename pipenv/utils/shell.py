...
def safe_expandvars(value: String | bool) -> String | bool | str:
...
def is_python_command(line: str):
    """
...
def env_to_bool(val: str | bool) -> bool:
    """
...
def project_python(project: Project | None, system: bool = False) -> str:
    if not system:
