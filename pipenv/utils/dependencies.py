...
def translate_markers(
    pipfile_entry: dict[str, str | String | list[str] | Array | bool]
) -> dict[str, str | String | list[str] | Array | bool]:
...
def clean_resolved_dep(
    project: Project,
    dep: dict[str, str | String | list[str] | Array | bool],
...
def dependency_as_pip_install_line(
    ...
    include_index: bool,
    indexes: list[Any | dict[str, String | bool]],
...
def convert_deps_to_pip(
    deps: dict[str, str],
    indexes: list[TSource] | None = None,
...
def parse_cfg_file(content: str) -> str | None:
...
def determine_vcs_specifier(package: InstallRequirement) -> str | None:
...
) -> tuple[InstallRequirement, None] | tuple[InstallRequirement, str]:
...
def get_constraints_from_deps(
    deps: dict[
        str, dict[Any, Any] | dict[str, list[Any]] | dict[str, list[str]] | dict[str, str]
    ]
) -> set[str]:
...
def is_required_version(
    version: str, specified_version: dict[str, str] | str | dict[str, str | list[str]]
) -> bool:
